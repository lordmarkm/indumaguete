...
$(document).ready(function(){
	...
	//textarea
	$longdescription.load('/indumaguete/resources/html/descriptions/' + modpage.item.domain + '.html');  
	$button_save.click(function() {
		modpage.save();
	});
	$button_done.click(function() {
		window.location.href = '/indumaguete/manage/' + modpage.item.domain + '/';
	});
...
<div id="content" class="ui-widget">
	<h2 id="header">Editing homepage of <span class="highligh">${item.name }</span></h2>
